...
public class MainActivity2 extends Activity {
	ListView lv2;
	String[] s={"240*320","128*160","176*220","176*208"};
        ...
        lv2.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int b,
				...
				case 0:
					...
					break;
				case 1:
					Intent intent2=new Intent(getApplicationContext(), MainActivity12.class);
					startActivity(intent2);
				case 2:
					Intent intent3=new Intent(getApplicationContext(), MainActivity12.class);
					startActivity(intent3);
				case 4:
					Intent intent4=new Intent(getApplicationContext(), MainActivity12.class);
